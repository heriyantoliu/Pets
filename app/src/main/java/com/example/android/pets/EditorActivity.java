...
public class EditorActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBreedEditText.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                mPetChanged = false;
                return false;
        ...
        mWeightEditText.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                mPetChanged = false;
                return false;
    ...
    private void deletePet(){
        if (mCurrentPetUri != null){
            ...
            if (rowsDeleted == 0){
                Toast.makeText(this, R.string.editor_insert_pet_failed, Toast.LENGTH_SHORT);
            }else{
                Toast.makeText(this, R.string.editor_insert_pet_successful, Toast.LENGTH_SHORT);
            }
        }
        finish();
    }
